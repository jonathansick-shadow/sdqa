...
class IsrSdqaStageTestCase(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        nBadCalibPixKey = policy.get("IsrSdqaStage.parameters.nBadCalibPixKey")
        nSaturatePixKey = policy.get("IsrSdqaStage.parameters.nSaturatePixKey")
        overscanMeanKey = policy.get("IsrSdqaStage.parameters.overscanMeanKey")
        overscanMeanUncKey = policy.get("IsrSdqaStage.parameters.overscanMeanUncKey")
        overscanStdDevKey = policy.get("IsrSdqaStage.parameters.overscanStdDevKey")
        overscanMedianKey = policy.get("IsrSdqaStage.parameters.overscanMedianKey")
        imageStdDevKey = policy.get("IsrSdqaStage.parameters.imageStdDevKey")
        imageClippedMeanKey = policy.get("IsrSdqaStage.parameters.imageClippedMeanKey")
        imageMedianKey = policy.get("IsrSdqaStage.parameters.imageMedianKey")
        imageMinKey = policy.get("IsrSdqaStage.parameters.imageMinKey")
        imageMaxKey = policy.get("IsrSdqaStage.parameters.imageMaxKey")
        xImageGradientKey = policy.get("IsrSdqaStage.parameters.xImageGradientKey")
        yImageGradientKey = policy.get("IsrSdqaStage.parameters.yImageGradientKey")
